...
Step number 3. install pakeage pygame with command pip install -r  requirements.txt
...
Step number 3. install pakeage pygame with command  pip3 install -r  requirements.txt
